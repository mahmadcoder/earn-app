...
const RegistrationForm = () => {
  ...
  // Using local proxy path, rewrites to your Railway backend
        ...
        <div className="max-w-md w-full space-y-6 bg-gray-900 p-8 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full bg-indigo-600 text-white py-2 rounded-md font-semibold transition duration-200 ${
